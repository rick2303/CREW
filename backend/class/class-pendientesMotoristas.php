...
public function guardarMotoristaPendiente(){
...
public static function obtenerMotoristasPendiente(){//nos ayuda a usarlo sin instanciarlo 
    $contenidoArhivo=file_get_contents('../data/pendientesMotoristas.json');
    echo $contenidoArhivo;

}
public static function obtenerMotoristaPendiente($indice){//nos ayuda a usarlo sin instanciarlo 
    $contenidoArhivo=file_get_contents('../data/pendientesMotoristas.json');
